#ifndef CGHOSTEASY_H_8428984951
#define	CGHOSTEASY_H_8428984951
...
/**
 * \brief A Class which controls an easy ghost.
 * 
 ...
 */
class CGhostEasy : public CMovingObject{
public:
    /**
     * \brief Initializes CGhostEasy and get his index and save it.
     * \param[in] alldata - to get ghost index from CData
     */
                 CGhostEasy(CData & alldata);
    /**
...
private:
    char m_LastChar; /**< a character on which the ghost is standing */
    int m_CycleCounter; /**< to prevent "dead-end-street" - after 50 iterations of no success the ghost turns around */
};
